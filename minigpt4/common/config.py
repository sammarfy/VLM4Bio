...
class Config:
    def __init__(self, args):
        ...
        model_config = self.build_model_config(config, args.model_cfg_name, **user_config)
    ...
    @staticmethod
    def build_model_config(config, model_cfg_name=None, **kwargs):
        ...
        if model_cfg_name is not None:
            model_config_path = model_config_path.split("/")[:-1]
            model_config_path.append(model_cfg_name)
            model_config_path = "/".join(model_config_path)
