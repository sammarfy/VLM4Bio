...
parser.add_argument("--task_option", "-t", type=str, default='selection', help="task option: 'selection' ")
...
# updated
parser.add_argument("--dataset", "-d", type=str, default='fish-easy', help="dataset option: 'fish-easy','fish-medium','bird-easy','bird-medium', 'butterfly-easy', 'butterfly-medium',  'butterfly-hard'")
...
if args.dataset == 'fish-easy':
    args.result_dir = root_dir+'VLM4Bio/easy_medium_hard_results/fish-easy'
    images_list_path = root_dir+'VLM4Bio/datasets/Fish/metadata/imagelist_easy.txt'
    image_dir = root_dir+'VLM4Bio/datasets/Fish/images'
    img_metadata_path = root_dir+'VLM4Bio/datasets/Fish/metadata/metadata_easy.csv'
    organism = 'fish'

elif args.dataset == 'fish-medium':
    args.result_dir = root_dir+'VLM4Bio/easy_medium_hard_results/fish-medium'
    images_list_path = root_dir+'VLM4Bio/datasets/Fish/metadata/imagelist_medium.txt'
    image_dir = root_dir+'VLM4Bio/datasets/Fish/images'
    img_metadata_path = root_dir+'VLM4Bio/datasets/Fish/metadata/metadata_medium.csv'
    organism = 'fish'

elif args.dataset == 'bird-easy':
    args.result_dir = root_dir+'VLM4Bio/easy_medium_hard_results/bird-easy'
    images_list_path = root_dir+'VLM4Bio/datasets/Bird/metadata/imagelist_easy.txt'
    image_dir = root_dir+'VLM4Bio/datasets/Bird/images'
    img_metadata_path = root_dir+'VLM4Bio/datasets/Bird/metadata/metadata_easy.csv'
    organism = 'bird'

elif args.dataset == 'bird-medium':
    args.result_dir = root_dir+'VLM4Bio/easy_medium_hard_results/bird-medium'
    images_list_path = root_dir+'VLM4Bio/datasets/Bird/metadata/imagelist_medium.txt'
    image_dir = root_dir+'VLM4Bio/datasets/Bird/images'
    img_metadata_path = root_dir+'VLM4Bio/datasets/Bird/metadata/metadata_medium.csv'
    organism = 'bird'

elif args.dataset == 'butterfly-easy':
    args.result_dir = root_dir+'VLM4Bio/easy_medium_hard_results/butterfly-easy'
    images_list_path = root_dir+'VLM4Bio/datasets/Butterfly_10k/metadata/imagelist_easy.txt'
    image_dir = root_dir+'VLM4Bio/datasets/Butterfly_10k/images'
    img_metadata_path = root_dir+'VLM4Bio/datasets/Butterfly_10k/metadata/metadata_easy.csv'
    organism = 'butterfly'

elif args.dataset == 'butterfly-medium':
    args.result_dir = root_dir+'VLM4Bio/easy_medium_hard_results/butterfly-medium'
    images_list_path = root_dir+'VLM4Bio/datasets/Butterfly_10k/metadata/imagelist_medium.txt'
    image_dir = root_dir+'VLM4Bio/datasets/Butterfly_10k/images'
    img_metadata_path = root_dir+'VLM4Bio/datasets/Butterfly_10k/metadata/metadata_medium.csv'
    organism = 'butterfly'

elif args.dataset == 'butterfly-hard':
    args.result_dir = root_dir+'VLM4Bio/easy_medium_hard_results/butterfly-hard'
    images_list_path = root_dir+'VLM4Bio/datasets/Butterfly_10k/metadata/imagelist_hard.txt'
    image_dir = root_dir+'VLM4Bio/datasets/Butterfly_10k/images'
    img_metadata_path = root_dir+'VLM4Bio/datasets/Butterfly_10k/metadata/metadata_hard.csv'
    organism = 'butterfly'
