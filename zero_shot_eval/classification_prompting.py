...
if args.dataset == 'fish-prompting':
    args.result_dir = osp.join(args.result_dir, 'fish-prompting')
    ...
    args.result_dir = osp.join(args.result_dir, 'bird-prompting')
    ...
    args.result_dir = osp.join(args.result_dir, 'butterfly-prompting')
