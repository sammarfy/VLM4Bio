...
if args.dataset == 'fish-10k':
    ...
    args.result_dir = root_dir+'VLM4Bio/results/fish-500'
    ...
    args.result_dir = root_dir+'VLM4Bio/results/butterfly-10k'
    
    images_list_path = root_dir+'VLM4Bio/datasets/Butterfly_10k/metadata/imagelist_10k.txt'
    image_dir = root_dir+'VLM4Bio/datasets/Butterfly_10k/images'
    img_metadata_path = root_dir+'VLM4Bio/datasets/Butterfly_10k/metadata/metadata_10k.csv'
    organism = 'butterfly'
