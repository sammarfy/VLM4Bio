...
# Added
parser.add_argument("--server", "-s", type=str, default='osc', help="server option: 'osc', 'pda'")
# 
...
if args.server == "arc":
    ...
    root_dir = '/fs/ess/PAS2136/VLM4Bio/'
#

# Added and please change result dir 
args.result_dir = root_dir + 'Bird500/results/bird_detection/'
#
...
if args.model in ['llava-v1.5-7b', 'llava-v1.5-13b']:
    ...
    model = LLaVA(
        ...
        # Added
        saved_model_dir = root_dir + f"llava_models/{model_version}.pt"
        #
    )
...
# Added
image_dir = root_dir + "datasets/Bird/images/"
image_trait_bbox_map_path = root_dir + "Bird500/BirdDatasetFiles/image_trait_bbox_map.json"
images_list_path = root_dir + "Bird500/BirdDatasetFiles/bird_image_list_filtered.txt"
#
...
img_metadata_path = root_dir + "datasets/Bird/metadata/bird_metadata_10k.csv"
# 
